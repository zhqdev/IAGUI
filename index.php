...
<head>
    ...
    <title>RobloxAI - Générateur de GUI Intelligent</title>
    <meta name="description" content="Créez des interfaces Roblox professionnelles avec l'aide de l'intelligence artificielle. Générez du code Lua et des éléments visuels pour vos GUIs.">
...
<body class="min-h-screen">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-400">Générateur de GUI Intelligent</p>
                    </div>
                </div>
                <nav class="hidden md:flex items-center space-x-6">
                    <a href="#generator" class="text-gray-300 hover:text-blue-400 transition-colors">Créateur</a>
    ...
    <section class="py-20 px-6">
        <div class="container mx-auto text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent">
                Créez des GUIs Roblox
                <span class="block">avec l'IA</span>
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                Créez des boutons et éléments visuels personnalisés pour vos interfaces Roblox avec des gradients, effets etanimations avancés.
            </p>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-800/30 rounded-lg p-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <label class="block text-gray-300 mb-2">Image/Icône</label>
                                        <div class="space-y-2">
                                            <input 
                                                type="file" 
                                                id="imageFile" 
                                            ...
                                            <div class="grid grid-cols-3 gap-2 mt-2">
                                                <button onclick="setImageUrl('https://cdn-icons-png.flaticon.com/512/3062/3062634.png')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xs text-gray-300">Bouclier</button>
                                                <button onclick="setImageUrl('https://cdn-icons-png.flaticon.com/512/2811/2811806.png')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xs text-gray-300">Épée</button>
                                                <button onclick="setImageUrl('https://cdn-icons-png.flaticon.com/512/3004/3004458.png')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xs text-gray-300">Couronne</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label class="block text-gray-300 mb-2">Emoji/Icône</label>
                                        <div class="grid grid-cols-6 gap-2">
                                            <button onclick="setEmoji('⚡')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xl">⚡</button>
                                            <button onclick="setEmoji('🔥')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xl">🔥</button>
                                            <button onclick="setEmoji('💎')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xl">💎</button>
                                            <button onclick="setEmoji('🎯')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xl">🎯</button>
                                            <button onclick="setEmoji('🏆')" class="bg-gray-700 hover:bg-gray-600 p-2 rounded text-xl">🏆</button>
                            ...
                            <div class="bg-gray-800/30 rounded-lg p-4">
                                ...
                                <!-- Gradient Presets -->
                                <div class="mt-4">
                                    <label class="block text-xs text-gray-400 mb-2">Gradients Prédéfinis</label>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <label class="flex items-center">
                                            ...
                                            <span class="text-gray-300">Ombre portée</span>
                                        </label>
                                    </div>
                                    <div>
                                        <label class="flex items-center">
                                    ...
                                    <div>
                                        <label class="block text-xs text-gray-400 mb-1">Intensité de l'effet</label>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-900 rounded-lg p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-semibold text-white">Aperçu en Temps Réel</h3>
                            ...
                            <!-- Export Options -->
                            <div class="bg-gray-800/30 rounded-lg p-4">
                                <h3 class="text-lg font-semibold text-white mb-3">Export & Téléchargement</h3>
                                <div class="grid grid-cols-2 gap-3 mb-4">
                            ...
                            <div id="robloxCodeOutput" class="bg-gray-800/30 rounded-lg p-4 hidden">
                                <div class="flex items-center justify-between mb-3">
                                    <h3 class="text-lg font-semibold text-white">Code Roblox Généré</h3>
    ...
    <section class="py-16 px-6 bg-black/30" id="templates">
        <div class="container mx-auto">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-bold text-blue-400 mb-4">Templates Prêts à Utiliser</h2>
                <p class="text-gray-300 text-lg">Choisissez parmi nos modèles prédéfinis pour commencer rapidement</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card hover:scale-105 transition-all cursor-pointer">
                    ...
                    <p class="text-gray-400 text-sm mb-3">Interface complète avec boutons animés et effets visuels</p>
                ...
                <div class="card hover:scale-105 transition-all cursor-pointer">
                    ...
                    <p class="text-gray-400 text-sm mb-3">Système complet de boutique avec grille d'objets</p>
                    <div class="flex justify-between items-center">
                ...
                <div class="card hover:scale-105 transition-all cursor-pointer">
                    ...
                    <h3 class="font-semibold text-white mb-2">Panneau de Paramètres</h3>
    ...
    <footer class="border-t border-gray-700 bg-black/50 py-12 px-6">
        <div class="container mx-auto">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Créez des interfaces Roblox professionnelles avec l'aide de l'intelligence artificielle.
                    </p>
                </div>
                <div>
                    <h4 class="font-semibold text-white mb-4">Outils</h4>
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li><a href="#generator" class="hover:text-blue-400 transition-colors">Générateur de Code</a></li>
                        <li><a href="#editor" class="hover:text-blue-400 transition-colors">Créateur d'Images</a></li>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm">© 2024 RobloxAI. Tous droits réservés.</p>
    ...
    <script>
        ...
        let currentButton = {
            ...
            color2: "#8B5CF6",
            iconPosition: "top",
            textSize: 22, // New property for text size
            iconSize: 35, // New property for icon/emoji size
            effects: {
                glow: false,
                shadow: false,
                stroke: false,
        ...
        function createPresetButton(type) {
            ...
            currentButton = { ...currentButton, ...preset };
        ...
        function handleImageUpload() {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    document.getElementById('imageUrl').value = 'Image locale chargée';
                    updateButton();
        ...
        function updateButton() {
            ...
            currentButton.imageUrl = document.getElementById('imageUrl').value;
            ...
            if (currentButton.imageUrl && currentButton.imageUrl !== '' && currentButton.imageUrl !== 'Image locale chargée') {
                if (currentButton.imageUrl.startsWith('data:image/')) {
                    ...
                    img.src = currentButton.imageUrl;
                } else {
                    // External URL
                    const img = new Image();
                    ...
                    img.onload = function() {
                        loadedImage = img;
                        drawAdvancedButton();
                        showToast('Image externe chargée!', 'success');
                    };
                    img.onerror = function() {
                        loadedImage = null;
                        drawAdvancedButton();
        ...
        function drawAdvancedButton(animationTime = 0) {
            ...
            // Calculate content layout based on what we have
            const hasImage = loadedImage !== null;
            const hasEmoji = currentButton.emoji && currentButton.emoji !== '';
        ...
        function clearCanvas() {
            ctx.clearRect(0, 0, canvas.width, canvas.height);
            showToast('Canvas effacé!', 'info');
        }

        // Refresh canvas
        function refreshCanvas() {
            updateButton();
            showToast('Canvas actualisé!', 'info');
        }
        ...
        function downloadImage(format) {
            ...
            showToast(`Image HD téléchargée en ${format.toUpperCase()}!`, 'success');
        }

        // Generate Roblox code
        function generateRobloxCode() {
            const buttonName = currentButton.text.replace(/\s+/g, '');
            const robloxCode = `-- ${currentButton.text} Button généré par RobloxAI
...
${buttonName}Button.Size = UDim2.new(0, 200, 0, 60)
${buttonName}Button.Position = UDim2.new(0.5, -100, 0.5, -30)
...
${currentButton.effects.stroke ? `-- Contour
UIStroke.Thickness = 2
UIStroke.Color = Color3.fromHex("${currentButton.textColor}")
...
${buttonName}Button.MouseButton1Click:Connect(function()
    print("${currentButton.text} cliqué!")
    -- Ajoutez votre logique ici
end)

-- Animation hover (optionnel)
${buttonName}Button.MouseEnter:Connect(function()
    ${buttonName}Button:TweenSize(UDim2.new(0, 210, 0, 63), "Out", "Quad", 0.2)
end)

${buttonName}Button.MouseLeave:Connect(function()
    ${buttonName}Button:TweenSize(UDim2.new(0, 200, 0, 60), "Out", "Quad", 0.2)
end)`;
            ...
            showToast('Code Roblox généré!', 'success');
        }
        ...
        function copyRobloxCode() {
            ...
            navigator.clipboard.writeText(code).then(() => {
                showToast('Code Roblox copié!', 'success');
            }).catch(() => {
...
SettingsFrame.BorderSizePixel = 0`
            ...
            if (code) {
                navigator.clipboard.writeText(code).then(() => {
                    showToast(`Template ${templateType} copié dans le presse-papiers!`, 'success');
                }).catch(() => {
